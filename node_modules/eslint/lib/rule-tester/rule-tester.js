...
function emitDeprecatedContextMethodWarning(ruleName, methodName) {
  if (!emitDeprecatedContextMethodWarning[`warned-${ruleName}-${methodName}`]) {
    emitDeprecatedContextMethodWarning[
      `warned-${ruleName}-${methodName}`
    ] = true
    process.emitWarning(
      ...
      Object.assign({}, rule, {
        ...
        create(context) {
          ...
          const newContext = Object.create(
            context,
            Object.fromEntries(
              Object.keys(DEPRECATED_SOURCECODE_PASSTHROUGHS).map(
                (methodName) => [
                  methodName,
                  {
                    value(...args) {
    ...
    function runRuleForItem(item) {
      ...
      assert(
        ...
        `A fatal parsing error occurred: ${
          fatalErrorMessage && fatalErrorMessage.message
        }`
      )
